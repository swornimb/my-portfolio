...
function MainLayout() {
  ...
  return (
    <>
      <div
        className={`${myTheme} bg-(--background) min-h-screen hidden xl:block`}
      ...
      <div className="block text-(--primary) h-screen bg-background text-3xl flex text-center items-center w-full overflow-hidden xl:hidden">
